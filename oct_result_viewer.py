...
class IndexTracker(object):
    ...
    def update(self):
        ...
        #self.background_points.axes.figure.canvas.draw()
        #self.scatter_points.axes.figure.canvas.draw()
        #self.background_heatmap.axes.figure.canvas.draw()
        #self.heatmap.axes.figure.canvas.draw()

# Input shape (depth, height, width)
def display_3d_image(image, points, heatmap, image_label, prediction):
